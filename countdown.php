...
add_action( 'admin_init', '\Countdown\has_word_wrap' );
...
function noticePhpVersionWrong() {
    ...
    echo '<div class="updated fade">' .
        __('Error: plugin "Countdown" requires a newer version of PHP to be running.',  'countdown').
        '<br/>' . __('Minimal version of PHP required: ', 'countdown') . '<strong>' . $minimalRequiredPhpVersion . '</strong>' .
        '<br/>' . __('Your server\'s PHP version: ', 'countdown') . '<strong>' . phpversion() . '</strong>' .
        '</div>';
}
...
function i18n_init() {
    ...
    load_plugin_textdomain('countdown', false, $pluginDir . '/languages/');
}
